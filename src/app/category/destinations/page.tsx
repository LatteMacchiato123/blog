...
export const metadata = {
  title: 'Destinations | Travelog',
  description: 'Destinations Category of Travelog ',
};
...
export default async function WellBeing() {
  ...
  const articlePosts = posts.filter((post) =>
    ...
    ).some((category) => category.fields.name === "Destinations")
  );
        ...
        {articlePosts.length > 0 ? (
          ...
          <div>
            <p className="text-2xl mt-20 mb-6">
              ...
              <span className="italic"> Destinations</span>. Cek postingan
              terbaru kami di bawah ini:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
