...
import { FoodHero } from "@/components/hero/FoodHero";


export const metadata = {
  title: 'Food | Travelog',
  description: 'Food Category of Travelog ',
};
...
export default async function WellBeing() {
  ...
  const articlePosts = posts.filter((post) =>
    (post.fields.categories as Entry<EntrySkeletonType, undefined, string>[])
      .some((category) => category.fields.name === "Food")
  );

  // Get the latest posts if there are no  posts
      ...
      <div className="max-w-screen-2xl mx-auto">
        {articlePosts.length > 0 ? (
          ...
          <div>
           ...
           Belum ada postingan dalam kategori<span className="italic"> Food</span>. Cek postingan terbaru kami di bawah ini:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
