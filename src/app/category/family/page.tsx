...
import { FamilyHero } from "@/components/hero/FamilyHero";
export const metadata = {
  title: 'Family | Travelog',
  description: 'Family Category of Travelog ',
};
...
export default async function WellBeing() {
  ...
  const articlePosts = posts.filter((post) =>
    (post.fields.categories as Entry<EntrySkeletonType, undefined, string>[])
      .some((category) => category.fields.name === "Family")
  );
      ...
      <div className="max-w-screen-2xl mx-auto">
        {articlePosts.length > 0 ? (
          ...
          <div>
           ...
           Belum ada postingan dalam kategori<span className="italic"> Family</span>. Cek postingan terbaru kami di bawah ini:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
